...
void QueuePairFactory::bindToPort(uint16_t port) {
  ...
  char *ipAddressOfDevice = infinity::utils::Address::getIpAddressOfInterface(
...
QueuePair *QueuePairFactory::connectToRemoteHost(const char *hostAddress,
...
QueuePair *QueuePairFactory::createLoopback(void *userData,
                                            uint32_t userDataSizeInBytes) {
